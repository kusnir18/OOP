 ...
 * This class Senior suits as an specific user category
 *
 *class Senior extends InsuredPerson implements Insured
 *
 * @author  Maros Kusnir
 * @version 1.0
 * @since   2019
...
public class Senior extends InsuredPerson implements Insured {
     ...
     */
    public Senior(PersonalInformation myInformation) {
        super(myInformation);
    }
     ...
     * it takes care of registration of Senior member
     */
    @Override
